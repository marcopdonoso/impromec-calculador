...
export default function LoadAreaTotals() {
  ...
  const [loadResistance, setLoadResistance] = useState<number | undefined>(undefined)
  ...
  useEffect(() => {
    ...
    const updateData = () => {
      ...
      if (activeSectorGlobal && activeSectorGlobal.results) {
        ...
        console.log('LoadAreaTotals: Usando datos del sector activo:', activeSectorGlobal.sectorName)
      }
      // Si no hay sector activo pero el proyecto tiene sectores, buscar uno con resultados
        ...
        if (sectorWithResults.results) {
          ...
          console.log('LoadAreaTotals: Usando datos del primer sector con resultados:', sectorWithResults.sectorName)
        }
      }
